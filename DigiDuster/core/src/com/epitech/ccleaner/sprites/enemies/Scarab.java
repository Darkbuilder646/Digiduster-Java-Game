...
public class Scarab extends Enemy {
  ...
  public static Texture texture = new Texture("enemies/scarab.png");
   ...
   */
  public Scarab(GameScreen screen, Cursor cursor, float x, float y) {
    super(screen, cursor, texture, x, y, 28, 54, 54, 200, 10, BodyDef.BodyType.DynamicBody);
  }
  ...
  public void followCursor() {
    float damping = 0.5f;
    float force = 25f; // Ajustez cette valeur en fonction de la vitesse souhaitée.
